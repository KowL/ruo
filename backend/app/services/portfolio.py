...
class PortfolioService:
    ...
    def _build_portfolio_response(self, portfolio: Portfolio) -> Dict:
        ...
        return {
            ...
            "costPrice": portfolio.cost_price,
            "quantity": portfolio.quantity,
            "currentPrice": profit_loss_data['currentPrice'],
            "marketValue": round(profit_loss_data['marketValue'], 2),
            "costValue": round(profit_loss_data['costValue'], 2),
            "profitLoss": round(profit_loss_data['profitLoss'], 2),
